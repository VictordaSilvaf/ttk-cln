...
export default function MenuComponent({ product, handleBuy }: MenuProps) {
    ...
    return (
        <Drawer>
            <div className="fixed bottom-0 left-0 right-0">
                <div className="p-4 py-1 bg-background border-t border-primary/5 z-10 flex flex-row pb-2 gap-2 pt-2">
                    <BottomNavButton
                        variant="icon"
                        icon={Store}
                        label="Shop"
                ...
                /> */}
                    ...
                    <DrawerTrigger asChild>
                        <BottomNavButton
                            ...
                            variant="price"
                            price={product.variations?.[0]?.pricePromotional?.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}
